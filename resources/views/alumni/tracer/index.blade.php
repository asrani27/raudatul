...
@section('content')
<br />
<form method="post" action="/alumni/tracer">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Silahkan Jawab Kuesioner Di Bawah Ini</h3>
                    <div class="card-tools">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" class="form-control" name="pertanyaan[]" value="{{$item->id}}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
