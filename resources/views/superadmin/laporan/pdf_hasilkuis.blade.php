...
<body>
    <header>
        ...
        <hr>
        <p><span class="auto-style1"><strong>LAPORAN DATA HASIL KUIS </strong></span></p>
    </header>
    <footer>
        <hr>
        ...
        <table cellpadding="5" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$item->nama}}</td>
                    <td>
                        @if ($item->hasilkuis == null)

                        @else
                        <ul>
                            @foreach ($item->hasilkuis as $d)
                            <li>Pertanyaan : {{$d->pertanyaan->pertanyaan}}<br />
                                Jawaban : {{$d->jawaban}}
                            </li>
                            @endforeach
                        </ul>
